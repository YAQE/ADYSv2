...
const TextType = ({
  ...
  const typingCompleteCalledRef = useRef<number>(-1);
    ...
    const executeTypingAnimation = () => {
      if (isDeleting) {
        ...
        if (currentCharIndex < processedText.length) {
          ...
          if (onTypingComplete && currentCharIndex === processedText.length && typingCompleteCalledRef.current !== currentTextIndex) {
            typingCompleteCalledRef.current = currentTextIndex;
